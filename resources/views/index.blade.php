<x-layout>
    ...
    <article class="main max-w-4xl mx-auto p-12 overflow-hidden">
        <h2 class="lowercase mb-4 text-sm">Arithmetic</h2>

        <dl class="flex flex-wrap gap-2">
            @foreach ($operators as $operator)
                {{--  Available attributes: category, index, slug, title, teaser, tags, related, contents --}}
                <dt>
                    <x-operator class="bg-php-violet hover:bg-white dark:bg-php-gray dark:hover:bg-php-gray-light"
                ...
                <dd class="basis-full my-8 last:mb-0" style="order:{{ count($operators) }}">
                    <div class="description relative bg-php-purple-bleak text-white py-4 md:py-12 dark:bg-php-gray">
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div class="relative bg-php-violet-dark rounded-md p-8 text-sm dark:bg-php-gray-dark">
                                <code>$a = 1 + 3; // 4</code>
